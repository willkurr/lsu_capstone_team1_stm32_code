...
extern touchgfx::GeneratedFont& getFont_Asap_Regular_62_4bpp();

const touchgfx::Font* touchgfx_fonts[] = {
    &(getFont_Asap_Regular_28_4bpp()),
    &(getFont_Asap_Regular_62_4bpp())
};
...
void resetFont(touchgfx::FontId fontId)
{
    ...
    {
    case 0:
        touchgfx_fonts[0] = &(getFont_Asap_Regular_28_4bpp());
        break;
    case 1:
        touchgfx_fonts[1] = &(getFont_Asap_Regular_62_4bpp());
        break;
    }
}
} // namespace TypedTextDatabase

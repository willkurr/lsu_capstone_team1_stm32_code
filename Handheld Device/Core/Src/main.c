...
int main(void)
{
  ...
  while (1)
  {
	  // Toggle the onboard LED on and off every 100ms
	  HAL_GPIO_WritePin(GPIOC, PWR_LED_Pin, GPIO_PIN_SET);
	  HAL_Delay(1000);
	  HAL_GPIO_WritePin(GPIOC, PWR_LED_Pin, GPIO_PIN_RESET);
	  HAL_Delay(1000);
    /* USER CODE END WHILE */
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LCD_CS_Pin|LCD_D_C_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : PWR_LED_Pin NRF24_CS_Pin NRF24_CE_Pin */
  GPIO_InitStruct.Pin = PWR_LED_Pin|NRF24_CS_Pin|NRF24_CE_Pin;
  ...
  /*Configure GPIO pins : BTN_RGT_Pin BTN_SEL_Pin BTN_DWN_Pin BTN_UP_Pin
                           BTN_PWR_Pin BTN_LFT_Pin */
  GPIO_InitStruct.Pin = BTN_RGT_Pin|BTN_SEL_Pin|BTN_DWN_Pin|BTN_UP_Pin
                          |BTN_PWR_Pin|BTN_LFT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
